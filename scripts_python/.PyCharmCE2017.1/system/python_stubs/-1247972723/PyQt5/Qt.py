# encoding: utf-8
# module PyQt5.Qt
# from /usr/lib/python2.7/dist-packages/PyQt5/Qt.x86_64-linux-gnu.so
# by generator 1.145
# no doc
...
from PyQt5.QtCore import (QAbstractAnimation, QAbstractEventDispatcher, 
    ...
    Q_RETURN_ARG, Qt, QtCriticalMsg, QtDebugMsg, QtFatalMsg, QtInfoMsg, 
    QtMsgType, QtSystemMsg, QtWarningMsg, bin_, bom, center, dec, endl, fixed, 
    flush, forcepoint, forcesign, hex_, left, lowercasebase, lowercasedigits, 
    noforcepoint, noforcesign, noshowbase, oct_, pyqtBoundSignal, 
    pyqtPickleProtocol, pyqtProperty, pyqtRemoveInputHook, 
    pyqtRestoreInputHook, pyqtSetPickleProtocol, pyqtSignal, pyqtSlot, 
    pyqtWrapperType, qAbs, qAddPostRoutine, qAddPreRoutine, qChecksum, 
    qCompress, qCritical, qDebug, qErrnoWarning, qFatal, qFloatDistance, 
    qFormatLogMessage, qFuzzyCompare, qInf, qInstallMessageHandler, qIsFinite, 
    qIsInf, qIsNaN, qIsNull, qQNaN, qRegisterResourceData, qRemovePostRoutine, 
    qRound, qRound64, qSNaN, qSetFieldWidth, qSetMessagePattern, qSetPadChar, 
...
PYQT_CONFIGURATION = {
    'sip_flags': '-x VendorID -t WS_X11 -t Qt_5_6_1 -x Py_v3',
}
