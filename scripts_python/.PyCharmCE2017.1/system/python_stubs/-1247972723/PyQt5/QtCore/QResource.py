...
class QResource(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    def registerResourceData(self, p_str, mapRoot=''): # real signature unknown; restored from __doc__
    ...
    def unregisterResourceData(self, p_str, mapRoot=''): # real signature unknown; restored from __doc__
